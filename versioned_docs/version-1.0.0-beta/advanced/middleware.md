...
- [Distributed Tracing](/docs/1.0.0-beta/advanced/distributed-tracing) - Advanced tracing patterns
- [Retry Mechanism](/docs/1.0.0-beta/advanced/retry-mechanism) - Handle failed messages
- [Prefetch Control](/docs/1.0.0-beta/advanced/prefetch-control) - Optimize message buffering